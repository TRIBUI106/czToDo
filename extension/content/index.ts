...
import { setupGmailIntegration } from './gmail';
import { setupSlackIntegration } from './slack';
...
if (window.location.hostname.includes('mail.google.com')) {
  setTimeout(() => setupGmailIntegration(), 1000);
}

// Initialize Slack integration
if (window.location.hostname.includes('slack.com')) {
  setTimeout(() => setupSlackIntegration(), 1000);
}
